...
public interface ForumFacade extends SearchEngine {
	 ...
	 */
	public UIMember login(final String username, final String password) throws NotRegisteredException, WrongPasswordException, DatabaseRetrievalException;
	...
	public UISubject addNewSubject(final long userID, final long fatherID, final String name, final String description)
			throws SubjectNotFoundException, SubjectAlreadyExistsException, NotRegisteredException, NotPermittedException, DatabaseUpdateException;
	...
	public UIThread openNewThread(final long userID, final long subjectID, final String topic, final String title,
			final String content) throws SubjectNotFoundException, NotRegisteredException, NotPermittedException, DatabaseUpdateException;
	...
	public UIMessage addNewReply(final long authorID, final long fatherID, final String title,
			final String content) throws MessageNotFoundException, NotRegisteredException, NotPermittedException, DatabaseUpdateException;
	...
	public UIMessage updateAMessage(final long userID, final long messageID, final String newTitle, 
			final String newContent) throws MessageNotFoundException, NotRegisteredException, NotPermittedException, DatabaseUpdateException;
	 ...
	 * @throws NotRegisteredException 
	 */
	public void deleteAMessage(final long userId, final long fatherID, final long messageID) throws MessageNotFoundException, NotRegisteredException, NotPermittedException, DatabaseUpdateException;
